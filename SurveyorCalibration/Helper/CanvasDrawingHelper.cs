...
// CanvasTag class
// Canvas shape removal by tag functions
//
...
namespace Surveyor.Helper
{
    ...
    {
        /// <summary>
        /// Draw a line on the CanvasFrame using the indicated brush and tag
        /// </summary>
        ...
        public static void DrawLine(Canvas canvas, Point start, Point end, double strokeThickness, Brush brush, CanvasTag canvasTag, PointerEventHandler? pointerMoved, PointerEventHandler? pointerPressed)
        {
            ...
            {
                Debug.WriteLine($"CanvasDrawingHelper.DrawLine: Exception raised, start ({start.X},{start.Y}). end ({end.X},{end.Y}), {canvasTag.TagType}/{canvasTag.TagSubType}, {ex.Message}");
            }
        }
        ...
        public static void DrawDot(Canvas canvas, Point center, double diameter, Brush brush, CanvasTag canvasTag, PointerEventHandler? pointerMoved, PointerEventHandler? pointerPressed)
        {
            ...
            { 
                ...
                Canvas.SetLeft(ellipse, center.X - (diameter / 2)); // Subtract half the width to center
                Canvas.SetTop(ellipse, center.Y - (diameter / 2)); // Subtract half the height to center
            ...
            {
                Debug.WriteLine($"CanvasDrawingHelper.DrawDot: Exception raised, center ({center.X},{center.Y}), diameter={diameter}, {canvasTag.TagType}/{canvasTag.TagSubType}, {ex.Message}");
            }
        }
                                      ...
                                      PointerEventHandler? pointerPressed)
        {
            ...
            {
                Debug.WriteLine($"CanvasDrawingHelper.DrawCircle: Exception raised, center ({center.X},{center.Y}), r={radius}, {canvasTag.TagType}/{canvasTag.TagSubType}, {ex.Message}");
            }
        }
        ...
        /// <summary>
        /// Draw a line on the CanvasFrame with arrow heads using the indicated brush and tag
        /// </summary>
        /// <param name="start"></param>
        /// <param name="end"></param>
        /// <param name="brush"></param>
        ...
        public static void DrawPolygonAcrylic(Canvas canvas, PointCollection points, Brush brush, CanvasTag canvasTag)
        {
            ...
            {
                Debug.WriteLine($"CanvasDrawingHelper.DrawPolygonAcrylic: Exception raised, {canvasTag.TagType}/{canvasTag.TagSubType}, {ex.Message}");
            }
        }

        /// <summary>
        /// Remove all the Canvas child shapes with the tag e.g. 'Event' or 'EpipolarLine'
        /// The tag format used is 'TagName':Guid
        /// e.g. Event:12345678-1234-1234-1234-1234567890AB
        /// </summary>
        /// <param name="tagRemove"></param>
        public static void RemoveCanvasShapesByTag(Canvas canvas, string tagRemove)
        {
        ...
        public static void RemoveCanvasShapesByTag(Canvas canvas, CanvasTag canvasTagRemove)
        {
            // Clear the canvas of all children tagged as 'Event'
            for (int i = canvas.Children.Count - 1; i >= 0; i--)
            {
    ...
    /// <summary>
    /// Class of embedding information in a Canvas child element
    /// Tag format:
    ...
    public class CanvasTag
    {
        ...
        /// <summary>
        /// Check if the tag and sub tag is of the indicated values 
        /// </summary>
        /// <param name="tagType"></param>
