                ...
                for (_PDA* itemPDA : itemIDA->TypePDA.PDAList) {
                    ...
                    if (itemPDA->matCollectionValues[4][0].empty())
                        ...
                        try {
                            ...
                            printf("Process: Bad fish count in PDA, on row: %i, setting count to -1.", outputRow->row);
                            outputRow->count = -1;
                        }
                    }
                ...
                for (_PDL* itemPDL : itemIDA->TypePDL.PDLList) {
                    ...
                    if (itemPDL->matCollectionValues[4][0].empty())
						...
						try {
                            ...
                            printf("Process: Bad fish count in PDL, on row: %i, setting count to -1.", outputRow->row);
                            outputRow->count = -1;
                        }
                    }
                ...
                for (_PD3* itemPD3 : itemIDA->TypePD3.PD3List) {
                    ...
                    if (itemPD3->matCollectionValues[4][0].empty())
                        ...
                        try {
                            ...
                            printf("Process: Bad fish count in PDS, on row: %i, setting count to -1.", outputRow->row);
                            outputRow->count = -1;                            
                        }                       
                    }
