...
namespace Surveyor.Helper
{
    public class DumpClassPropertiesHelper
    {
        ...
        //    Debug.WriteLine($"--- Start Dumping properties for {type.Name} ---");
        ...
        //        {
        //            Debug.WriteLine("[Warning] Both include and ignore lists provided. 'include' list will take precedence.");
        //        }
        //    }
        ...
        //    // Only show properties declared in this class or those explicitly included
        ...
        //        bool isExplicitlyIncluded = includeList?.Contains(propName) == true;

        //        if (!isDeclaredHere && !isExplicitlyIncluded)
        //            continue;

        //        if (includeList != null && !includeList.Contains(propName))
        //            continue;

        //        if (ignoreList != null && ignoreList.Contains(propName))
        //            continue;
        ...
        //            if (value == null)
        //            {
        //                Debug.WriteLine($"{indent}{propName} = null");
        //            }
        //            else
        //            {
        //                Debug.WriteLine($"{indent}{propName} = {value}");

        //                // Look for DumpAllProperties method
        //                var method = value.GetType().GetMethod("DumpAllProperties", BindingFlags.Public | BindingFlags.Instance);
        //                if (method != null && method.GetParameters().Length == 0)
        //                {
        //                    Debug.WriteLine($"{indent}↳ Calling DumpAllProperties on {propName}:");
        ...
        //        catch (Exception ex)
        //        {
        //            Debug.WriteLine($"{indent}{propName} = [Error reading: {ex.Message}]");
        //        }
        //    }

        //    Debug.WriteLine($"--- End Dumping properties for {type.Name} ---");
        //}
